...
np.savetxt("zfp_nyx3log10bige_cr.txt" , cr ,delimiter='\t')
np.savetxt("zfp_nyx3log10bige_psnr.txt" , psnr ,delimiter='\t')
np.savetxt("zfp_nyx3log10bige_maxpwerr.txt" , maxpwerr ,delimiter='\t')