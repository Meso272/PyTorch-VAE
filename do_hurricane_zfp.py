...
np.savetxt("zfp_hurricane_cr.txt" , cr ,delimiter='\t')
np.savetxt("zfp_hurricane_psnr.txt" , psnr ,delimiter='\t')
np.savetxt("zfp_hurricane_maxpwerr.txt" , maxpwerr ,delimiter='\t')